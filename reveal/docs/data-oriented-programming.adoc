...
[.notes]
--
* Explain what is data oriented programming

* Explicitly mention that I assume you like the fact that Clojure is dynamically typed

* It's not about a war between static and dynamic types
